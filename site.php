...
$app->get("/checkout", function(){
	...
	if (isset($_GET['zipcode'])){
		...
		$cart->setdeszipcode($_GET['zipcode']);  // caso tenha mudado o cep no carrinho
		$cart->save();
		$cart->getCalculateTotal(); // recalcula o total , caso mudou o cep
...
$app->post("/profile/change-password", function() {
	...
	if (!isset($_POST['new_pass']) || $_POST['new_pass'] === ''){
		User::setError("Digite a nova atual.");
		header("Location: /profile/change-password");
		exit;
	}
